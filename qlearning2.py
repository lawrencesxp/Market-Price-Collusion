...
# Configuration
num_days_pre_training = 100
num_days_multi_agent = 100
num_airlines = 5
...
def save_final_results():
    ...
    if current_day > 0:
        ...
        ax4.grid(True)
        fig.tight_layout()
        plt.savefig(f'reinforcement_learning_results_{current_phase}.png')
        print(f"Static plot saved as 'reinforcement_learning_results_{current_phase}.png'.")
